...
# Resgate da API Key via Secrets do Streamlit Cloud ou campo lateral
...
if st.button("🚀 Processar Auditoria", type="primary"):
    ...
    if not final_key:
        st.error("⚠️ Insira uma chave de API do Gemini válida para prosseguir.")
        ...
        try:
            ...
            with st.spinner("Analisando holerites com IA..."):
                for pdf_file in uploaded_pdfs:
                    ...
                    prompt = (
                        ...
                        "o valor líquido a receber (como número float numérico) e o mês de referência no formato MM/AAAA."
                    )
            ...
            st.error(f"❌ Erro ao validar a chave ou processar: {e}")
